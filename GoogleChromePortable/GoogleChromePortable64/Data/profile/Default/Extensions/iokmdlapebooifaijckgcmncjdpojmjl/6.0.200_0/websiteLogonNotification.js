...
var websiteLogonNotification = {
    ...
    receiveBG: function (msg) {
        ...
        switch (msg.cmd) {
            ...
            case "showregister":
                ...
                this.showNotificationFrame("register", msg);
                break;
            case "updateui":
    ...
    showNotificationFrame: function (type, param) {
        ...
        try {
            ...
            if (type == "logon") {
                ...
                //For logo
                if (document.getElementById("logon_content").innerHTML.indexOf("Fingerprint Reader") < 0) {
                    document.getElementById("wlo_logo").src = chrome.extension.getURL("images/logo_pv.png");
                } else {
                ...
                //For logo
                if (document.getElementById("register_content").innerHTML.indexOf("Password Vault") > -1) {
                    document.getElementById("wlo_logo").src = chrome.extension.getURL("images/logo_pv.png");
                } else {
                    document.getElementById("wlo_logo").src = chrome.extension.getURL("images/logo_32.png");
                }
    ...
    initRegisterNotification: function (param) {
        ...
        //Add localization
        if (param.sensorconnected) {
            document.getElementById("register_content").innerHTML = chrome.i18n.getMessage("IDS_SAVE_PASSWORD_NOTICE").replace("TrueSuite", "Fingerprint Reader");
        } else {
            document.getElementById("register_content").innerHTML = chrome.i18n.getMessage("IDS_SAVE_PASSWORD_NOTICE").replace("TrueSuite", "Password Vault");
        }
        ...
        switch (type) {
                ...
                if (logo && logonInfo) {
                    ...
                    setTimeout(function () {
                        if (logo.src == chrome.extension.getURL("images/error_32.png")) {
                            logonInfo.innerHTML = websiteLogonNotification._currentPrompt ? chrome.i18n.getMessage(websiteLogonNotification._currentPrompt).replace("TrueSuite", "Fingerprint Reader") : chrome.i18n.getMessage("IDS_SWIPE_FINGER").replace("TrueSuite", "Fingerprint Reader");
                            if (logonInfo.innerHTML.indexOf("Fingerprint Reader") < 0) {
                                logo.src = chrome.extension.getURL("images/logo_pv.png");
                            } else {
            ...
            case "logon_show":
                ...
                if (temp[0] == "nopassword") {
                    ...
                    document.getElementById("wlo_password_container").style.display = "";
                    document.getElementById("logon_button").style.display = "";
                }
                if (temp[1]) {
                    this._currentPrompt = temp[1];
                    document.getElementById("logon_content").innerHTML = chrome.i18n.getMessage(temp[1]).replace("TrueSuite", "Fingerprint Reader");
            ...
            case "swipe_focused":
                document.getElementById("wlo_logo").src = chrome.extension.getURL("images/logo_32.png");
                document.getElementById("logon_content").innerHTML = chrome.i18n.getMessage(this._currentPrompt).replace("TrueSuite", "Fingerprint Reader");
                break;
